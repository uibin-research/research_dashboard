...
DEPT_ORDER = [
    "인문대학", "사회과학대학", "경영대학",
    "미디어·휴먼라이프대학", "인공지능·소프트웨어융합대학", "미래융합대학",
    "화학·생명과학대학", "스마트시스템공과대학", "반도체·ICT대학",
    "스포츠·예술대학", "건축대학", "방목기초교육대학",
    "(일반)대학원", "기록정보과학전문대학원", "통합치료대학원", "교육대학원",
...
def page_overview():
    ...
    st.markdown('<div class="section-title">단과대학별 실적 건수</div>', unsafe_allow_html=True)
